...
-- Keep cursor in the middle of the page when moving half a page down/up
vim.keymap.set('n', '<C-d>', '<C-d>zz', { desc = 'Move half a page down' })
vim.keymap.set('n', '<C-u>', '<C-u>zz', { desc = 'Move half a page up' })

-- Allow hjkl motions while in insert mode
...
-- Keybind to minify JSON. Use conform to format.
vim.api.nvim_create_autocmd('FileType', {
  pattern = 'json',
  callback = function()
    vim.keymap.set('n', '<leader>m', '<cmd>%!jq -c<CR>', { desc = '[M]inify JSON' })
  end,
})
...
require('lazy').setup({
  ...
  -- Alternatively, use `config = function() ... end` for full control over the configuration.Add commentMore actions
  ...
  },
  {
    ...
    config = function()
      ...
      -- Diagnostic ConfigAdd commentMore actions
